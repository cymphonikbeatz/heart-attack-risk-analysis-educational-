...
#define EI_CLASSIFIER_PROJECT_ID                 1096455
#define EI_CLASSIFIER_PROJECT_OWNER              "singularity"
#define EI_CLASSIFIER_PROJECT_NAME               "Heart Attack Risk Analysis - Edge Impulse Model"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "Age + Cholesterol + Heart Rate + Diabetes + Family History + Smoking + Obesity + Alcohol Consumption + Exercise Hours Per Week + Previous Heart Problems + Medication Use + Stress Level + Sedentary Hours Per Day + Income + BMI + Triglycerides + Physical Activity Days Per Week + Sleep Hours Per Day"
